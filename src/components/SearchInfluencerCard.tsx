...
const SearchInfluencerCard = ({ influencer }: Props) => {
  return (
    <Link
      ...
      className="flex flex-col group bg-[#50ad40] p-0 rounded-lg shadow-md transition-transform transform hover:scale-105"
    >
      ...
      <div className="flex flex-row justify-center items-center">
        <h3 className="h-[30px] m-4 text-sm tracking-tight mb-1 group-hover:underline text-[#ffffff] text-center overflow-hidden text-ellipsis whitespace-nowrap max-w-[75%]">
          {influencer.bio}
        </h3>
        <svg width="28" height="28" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.5" y="0.5" width="35" height="35" rx="17.5" stroke="#ffffff" fill="#ffffff"/>
